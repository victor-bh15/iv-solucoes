  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="mt-12 text-sm leading-relaxed text-ink/70">
        <p>
          Esta política explica como a <strong className="text-ink">IV Soluções</strong>{" "}
          ...
          <strong className="text-ink"> Ponto Eletrônico</strong> é tratado na seção 4.
        </p>

        <div className="mt-6 border border-line p-4">
          <p>
            O aplicativo{" "}
            <strong className="text-ink">Villas Park III</strong> (gestão de condomínio)
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            <strong className="text-ink">Mensagens do assistente virtual:</strong> o
            texto que você digita no chat do site.
          </li>
          <li>
            <strong className="text-ink">Contato voluntário:</strong> os dados que você
            decide nos enviar por WhatsApp ou e-mail (como nome e telefone).
          </li>
          <li>
            <strong className="text-ink">Preferências do site:</strong> tema (claro/escuro)
        ...
        <p>
          O <strong className="text-ink">Ponto Eletrônico</strong> é um aplicativo de
        ...
        <h3 className="mt-6 mb-2 text-base text-ink">
          4.1. Dados que o aplicativo coleta
        </h3>
        <ul className="list-disc space-y-1 pl-5">
          <li>
            <strong className="text-ink">Selfie (foto facial):</strong> capturada no
          ...
          <li>
            <strong className="text-ink">Localização (GPS):</strong> capturada
            <strong className="text-ink"> apenas no momento do registro</strong> do ponto
            (entrada e saída), para comprovar o local em que ele foi batido. Não há rastreamento
            contínuo nem em segundo plano.
          </li>
          <li>
            <strong className="text-ink">CPF:</strong> usado como identificador de login
            (alternativa ao e-mail).
          </li>
          <li>
            <strong className="text-ink">Cadastro do profissional:</strong> nome, e-mail,
            telefone e horário de trabalho.
          </li>
          <li>
            <strong className="text-ink">Registros de ponto:</strong> data, hora e tipo
            (entrada/saída).
          </li>
        </ul>

        <h3 className="mt-6 mb-2 text-base text-ink">4.2. Finalidade e base legal</h3>
        <p>
        ...
        <h3 className="mt-6 mb-2 text-base text-ink">4.3. Retenção</h3>
        <p>
          A <strong className="text-ink">selfie é apagada após 90 dias</strong>, mantendo-se
        ...
        <h3 className="mt-6 mb-2 text-base text-ink">4.4. Armazenamento e acesso</h3>
        <p>
          ...
          aos seus registros. <strong className="text-ink">Não vendemos nem
          compartilhamos</strong> esses dados com terceiros para fins de marketing.
        </p>

        <h3 className="mt-6 mb-2 text-base text-ink">4.5. Direitos do titular</h3>
        <p>
        ...
        <p>
          ...
          (Google Analytics). <strong className="text-ink">Não vendemos nem
        ...
        <p>
          ...
          ele é configurado com <strong className="text-ink">anonimização de IP</strong> e
